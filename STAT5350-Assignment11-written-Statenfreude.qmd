...
```
## Research Question
What study strategies do university students think are effective and therefore
used more frequently? To attempt to answer this question, university students
were asked some questions about their habits. The implicit assumption is that
students do things they think are effective, so verbal frequency and Likert
scales were used to gauge which strategies they use. There is a body of evidence
that indicates that many popular learning methods, including highlighting and
rereading are ineffective. The same body of research indicates that recall is a
highly effective learning strategy ($(\text{Brown, Rudiger \& McDonald,2014})^1$).
...
sum_stats |> kable(
  caption="Descriptive statistics for questions 1-3. Quesion 2 has the 
           highest median endorsement of the 3 questions."
)
```
